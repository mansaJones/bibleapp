...
class AlertMesage: NSObject {
    public class func show(_ theme: Theme, title: String? = nil, message: String?) {
        ...
        case .info:
            ...
            view.configureTheme(backgroundColor: R.color.a4C1A00()!, foregroundColor: .white, iconImage: iconStyle.image(theme: .info), iconText: nil)
            view.titleLabel?.text = "Info"

        case .success:

            view.configureTheme(backgroundColor: R.color.green()!, foregroundColor: .white, iconImage: iconStyle.image(theme: .warning), iconText: nil)
            view.iconImageView?.image = view.iconImageView?.image!.withRenderingMode(.alwaysTemplate)
            view.iconImageView?.tintColor = R.color.gradient4()!
        ...
        case .warning:
            ...
            view.configureTheme(backgroundColor: R.color.a4C1A00()!, foregroundColor: .white, iconImage: iconStyle.image(theme: .warning), iconText: nil)
            view.iconImageView?.image = view.iconImageView?.image!.withRenderingMode(.alwaysTemplate)
            view.iconImageView?.tintColor = R.color.gradient4()!
        ...
        case .error:
            ...
            view.configureTheme(backgroundColor: R.color.ff0000()!, foregroundColor: .white, iconImage: iconStyle.image(theme: .error), iconText: nil)
        ...
        // Set Font
        view.titleLabel?.font = R.font.magra(size: 16)
        view.bodyLabel?.font = R.font.magra(size: 14)
        //
        // Set Shadow
    ...
    public class func showInternetNotConnected(message: String = "Internet Connection Lost") {
        ...
        view.configureTheme(backgroundColor: R.color.ff0000()!,
